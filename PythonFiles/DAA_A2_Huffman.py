...
# A supporting function to calculate the probabilities of symbols in specified data
...
# A supporting function to print the codes of symbols by traversing a
# Huffman Tree
the_codes = dict()
...
# A supporting function to get the encoded result
...
# A supporting function to calculate the space difference between compressed & non-compressed data
...
def HuffmanEncoding(the_data):
    ...
    while len(the_nodes) > 1:
        ...
        newNode = Nodes(left.probability + right.probability, left.symbol
